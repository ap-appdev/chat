...
export default {
   ...
   shopWithAlgolia: 'Магазин с Алголией',
   cart: 'телега',
   ...
   currenciesAvailable:"Доступные валюты",
   receivedAmount:"Полученная сумма",
   sentAmount:"Отправленная сумма",
   totalAmount:"Итого",
   walletAddress:"Кошелек адрес",
   withdraw:"Изымать",
   deposit:"депозит",
   ...
   transferCryptocurrency:"Трансферная криптовалюта",
   buyOrSell:"Buy / продавать",
   crm:"CRM",
   crypto:"крипто-",
   supervisor:"Руководитель",
   duration:"продолжительность",
   netWorth:"Чистая стоимость",
   liveChatSupport:"Поддержка Live Chat",
   ...
   editDetail :"Редактировать деталь",
   
   fileInput:"Ввод файла",
   colorPickers:"Палитры цветов",
   size:"Размер",
   validation:"Проверка",
   playground:"Детская площадка",
   chipGroups:"Чип Группы",
   overlays:"Накладки",
   slideGroups:"Слайд-группы",
   simpleTable:"Простая таблица",
   listItemGroups:"Группы элементов списка",
   banners: "Баннеры",
   appBars: "Панель приложений"
}
