 ...
 */
export default {
	appLogo: '/static/img/ingrape-logo.png',                                   // App Logo,
	darkLogo: '/static/img/ingrape-logo.png',							    // dark logo
	appLogo2: '/static/img/ingrape-logo.png',                                    // App Logo 2 For Login & Signup Page
